...
export default function DistribuidoraPapa() {
        ...
        <section id="main" className="py-12">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link to="/product/pastusa" className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-200 ease-in-out">
              ...
              <Link to="/product/criolla" className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-200 ease-in-out">
              ...
              <Link to="/product/tocarrena" className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-200 ease-in-out">
        ...
        <section id="blog" className="bg-gray-100 py-12">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link to="/blog/recetas" className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-200 ease-in-out">
              ...
              <Link to="/blog/beneficios" className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-200 ease-in-out">
              ...
              <Link to="/blog/sostenible" className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-200 ease-in-out">
